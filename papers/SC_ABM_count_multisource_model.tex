...
($m\sim10^2$--$10^3$, $T\sim10$--$20$), evaluating this sum at every surrogate variational sweep is computationally
prohibitive, blocking any fast deterministic surrogate inference scheme.
...
the algorithm converges in only 6 forward-filtering sweeps; the stronger data signal overcomes the
...
E-step runs the forward-filtering sweeps of Algorithm~\ref{alg:cavi} with the current
